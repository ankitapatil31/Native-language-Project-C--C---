            ...
            case 1:
                    do
                    {
                        ...
                        switch(iCase)
                        {
                            case 1: 
									#if logmain
										printf("In Insert First Section : \n");
									#endif
									
                                    printf("\nEnter Data Which You Want To Insert in LinkList:- ");
                                    scanf("%d",&iNo);
									#if logmain
										printf("Insert First call\n");
									#endif
                            ...
                            case 3:
									...
									#if logmain
										printf("In Insert At Position Section : \n");
									#endif
                                    ...
                                    if(iPos>=1&&iPos<=CountNode(pFirst,pLast)+1)
                                    {
                                        ...
                                        scanf("%d",&iNo);
										#if logmain
											printf("Insert At Position Function call\n");
										#endif
            ...
            case 2:
                    ...
                    do
                    {
                        ...
                        switch(iCase)
                        {
                            case 1:
									#if logmain
										printf("In Delete First Section : \n");
									#endif
                                    ...
                                    {   
										#if logmain
											printf("Delete First Function call\n");
										#endif
                            ...
                            case 3:
									#if logmain
										printf("In Delete At Position Section : \n");
									#endif
                                    if(NULL==pFirst)
                                    {    
                                        printf("\nLinkedList Is All Ready Empty\n");
                                    ...
                                    {
										#if logmain
											printf("Delete At Position call\n");
										#endif
            ...
            case 3:
                    ...
                    do
                    {
                        ...
                        switch(iCase)
                        {
                            case 1:
									#if logmain
										printf("In SearchFirstOccurrence Section : \n");
									#endif
									...
									#if logmain
										printf(" SearchFirstOccurrence Function call : \n");
									#endif
									iPos = 0;
                            ...
                            case 2:
									#if logmain
										printf("In SearchLastOccurrence Section : \n");
									#endif
                                    printf("\nEnter a Key value for Search :- ");
                                    scanf("%d",&iNo);  
									#if logmain
                            ...
                            case 3: 
									#if logmain
										printf("In SearchAllOccurrence Section : \n");
									#endif
                                    printf("\nEnter a Key value for Search :- ");
                                    scanf("%d",&iNo);  
									#if logmain
										printf("SearchAllOccurrence Function call \n");
									#endif
